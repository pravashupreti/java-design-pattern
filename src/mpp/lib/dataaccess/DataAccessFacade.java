...
public class DataAccessFacade implements DataAccess {
	...
	public static final String OUTPUT_DIR = System.getProperty("user.dir") 
			+ "/src/mpp/lib/dataaccess/storage";
	...
	public void addBookCopy(String isbn, int numOfCopies) throws RuntimeException {
		...
		if (null == book) {
			throw new RuntimeException("Given book isbn is not existed.");
		}
	...
	public void updateCheckout(Book book) {
		HashMap<String, Book> mapBook = readBookMap();
		mapBook.put(book.getIsbn(), book);
		saveToStorage(StorageType.BOOKS, mapBook);
	}
	...
	static void loadAuthorMap(List<Author> authorList) {
		...
		authorList.forEach(auth -> authors.put(auth.getAuthorID(), auth));
