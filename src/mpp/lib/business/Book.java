...
final public class Book implements Serializable {
	...
	/*
	 * public Book(String isbn, String title, int maxCheckoutLength, List<Author>
	 * authors) { this.isbn = isbn; this.title = title; this.maxCheckoutLength =
	 * maxCheckoutLength; this.authors = Collections.unmodifiableList(authors);
	 * copies = new BookCopy[] { new BookCopy(this, 1, true) }; }
	 */

	public Book(String isbn, String title, int maxCheckoutLength, List<Author> authors, int numOfCopies) {
		this.isbn = isbn;
		this.title = title;
		this.maxCheckoutLength = maxCheckoutLength;
		this.authors = Collections.unmodifiableList(authors);
		copies = new BookCopy[numOfCopies];
